...
import com.yash10019coder.whatsapp.databinding.ActivitySigninBinding;
...
//                progressDialog.show();
        ...
        binding.btnsignin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (!binding.etemail.getText().toString().trim().equals("") && !binding.etpassword.getText().toString().trim().equals("")) {
                    progressDialog.show();
                    auth.signInWithEmailAndPassword(binding.etemail.getText().toString().trim(), binding.etpassword.getText().toString().trim()).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        @Override
...
//                    binding.etemail.setHintTextColor();
                    ...
                    binding.etpassword.setHint("Enter correct Password");
                }
            }
        });
